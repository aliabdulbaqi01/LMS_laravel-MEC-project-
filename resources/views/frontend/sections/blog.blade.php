    ...
    <div class="container">
        ...
        <div class="blog-post-carousel owl-action-styled half-shape mt-30px">
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3">
                        ...
                        <div class="share-wrap">
                            <ul class="social-icons social-icons-styled">
                                ...
                                <li class="mr-0"><a href="#" class="instagram-bg"><i class="la la-instagram"></i></a>
                                </li>
                            </ul>
            ...
            <div class="card card-item">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="blog-single.html">Ultimate Photoshop Training: From Beginner</a>
                    </h5>
                    <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
                        <li class="d-flex align-items-center">By<a href="#">TechyDevs</a></li>
                        <li class="d-flex align-items-center"><a href="#">4 Comments</a></li>
