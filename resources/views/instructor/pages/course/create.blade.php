            ...
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('courses.store') }}" method="post" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="course_name" class="form-control" id="CourseName"  value="{{old('course_name')}}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="CourseTitle" class="form-label">Course Title </label>
                        <input type="text" name="course_title" value="{{old('course_title')}}" class="form-control" id="CourseTitle"  >
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="certificate" class="form-select mb-3" aria-label="Default select example">
                            <option @selected( old('certificate') == 'Yes') value="Yes">Yes</option>
                            <option @if(old('certificate') == 'No') selected @endif value="No">No</option>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="selling_price" value="{{old('selling_price')}}" class="form-control" id="input1"  >
                    </div>
                    <div class="form-group col-md-3">
                        <label for="input1" class="form-label">Discount Price </label>
                        <input type="text" name="discount_price" value="{{old('discount_price')}}" class="form-control" id="input1"  >
                    </div>
                    <div class="form-group col-md-3">
                        <label for="input1" class="form-label">Duration </label>
                        <input type="text" name="duration" value="{{old('duration')}}" class="form-control" id="input1"  >
                    </div>
                    <div class="form-group col-md-3">
                        <label for="input1" class="form-label">Resources </label>
                        <input type="text" name="resources" value="{{old('resources')}}" class="form-control" id="input1"  >
                    </div>
                    <div class="form-group col-md-12">
                        <label for="input1" class="form-label">Course Prerequisites </label>
                        <textarea name="prerequisites" class="form-control"  id="input11" placeholder="Prerequisites ..." rows="3">{{old('prerequisites')}}</textarea>
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="row add_item">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="course_goals[]" id="goals" value="{{old('course_goals[0]')}}" class="form-control" placeholder="Goals ">
                            </div>
                        </div>
