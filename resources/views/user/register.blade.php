                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <form method="post" class="pt-4" action="{{ route('register') }}">
                                ...
                                <div class="input-box">
                                    <label class="label-text" id="name">Name</label>
                                    <div class="form-group">
                                        <input class="form-control form--control
                                        @error('name') is-invalid @enderror" id="name" type="text" name="name" placeholder="name" value="{{old('name')}}">
                                ...
                                <div class="input-box">
                                    <label class="label-text" id="username">Username</label>
                                    <div class="form-group">
                                        <input class="form-control form--control @error('username') is-invalid @enderror"
                                               type="text" id="username" name="username" placeholder="Username" required value="{{old('username')}}">
                                        <span class="la la-user input-icon"></span>
                                    </div>
                                    @error('username') <span class="text-danger">{{$message}}</span> @enderror
                                </div><!-- end input-box -->
                                <div class="input-box">
                                    <label class="label-text" id="email">Email</label>
                                    <div class="form-group">
                                        <input class="form-control form--control @error('email') is-invalid @enderror"
                                               type="email" id="email" name="email" placeholder="Enter email address" required value="{{old('email')}}">
                                ...
                                <div class="input-box">
                                    <label class="label-text" id="password">Password</label>
                                    <div class="input-group mb-3">
                                        <span class="la la-lock input-icon"></span>
                                        <input class="form-control form--control password-field @error('password') is-invalid @enderror"
                                               type="password" id="password" name="password" placeholder="Password" required value="{{old('password')}}">
                                ...
                                <div class="btn-box">
                                    ...
                                    <div class="custom-control custom-checkbox mb-4 fs-15">
                                        ...
                                        <label class="custom-control-label custom--control-label" for="agreeCheckbox">by signing i agree to the
                                            <a href="{{route('terms_and_conditions')}}" class="text-color hover-underline" target="_blank">terms and conditions</a> and
                                            <a href="{{route('privacy_policy')}}" class="text-color hover-underline" target="_blank" >privacy policy</a>
                                        </label>
                                    </div><!-- end custom-control -->
